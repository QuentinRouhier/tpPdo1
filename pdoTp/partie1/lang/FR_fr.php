<?php
define('HOME','Accueil');
define('PART_ONE','partie 1');
define('PART_TWO','partie 2');
define('ADD_USER','Ajout d\'un utilisateur');
define('FIRST_NAME','Prenom');
define('LAST_NAME','Nom de famille');
define('SERVICE_GROUP','Nom du service');
define('BIRTHDATE','Anniversaire');
define('ADRESS','Adresse');
define('CITY','Ville / Village');
define('POSTAL_CODE','Code postale');
define('PHONE_NUMBER','Numéro de telephone');
define('ADD','Valider');
